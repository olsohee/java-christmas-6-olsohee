...
class CategoryTest {
    ...
    void isDrinkMenu(Menu menu) {
        Assertions.assertThat(Category.DRINK.isContain(menu)).isTrue();
    }
    ...
    void isDessertMenu(Menu menu) {
        Assertions.assertThat(Category.DESSERT.isContain(menu)).isTrue();
    }
    ...
    void isMainMenu(Menu menu) {
        Assertions.assertThat(MAIN.isContain(menu)).isTrue();
    }
}
